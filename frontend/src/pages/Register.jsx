  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#070B14] p-4">
      <form onSubmit={handleSubmit} className="w-full max-w-sm bg-[#0F1626] border border-[#1E2A44] rounded-2xl p-6">
        ...
        <p className="text-xs text-slate-500 font-mono mb-5">create an account to save your progress</p>
        ...
        <label className="block text-[11px] font-mono text-slate-500 mb-1">NAME</label>
        <input
          required
          value={form.name}
